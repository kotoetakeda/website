...
const Home = () => {
  ...
  const IntroSpace = "min-h-[30vh] sm:min-h-[30vh] md:min-h-[30vh] lg:min-h-[40vh] xl:min-h-[40vh]";
  ...
  return (
    <>
      ...
      <div className="flex flex-col flex-1">
        {/* Intro */}
        <div className= {`${IntroSpace} flex flex-1 items-end justify-start `}>
        ...
        <div className="flex flex-1 w-[80vw] items-center justify-end">
          <img className="object-cover rounded-full" src={Profile_Home} alt="A picture of me"/>
        </div>
